                    ...
                    <div className="display_sign">
                        <form onSubmit={onSignupSumbit} className="signup_form" style={{ display:'flex',flexDirection:'column'}}>
                            <label className="name-label">
                                <input onChange={onChangeName} value={name} className="signup_name" type="text" name="name" placeholder="이름"  />
                            </label>

                            <label className="email-label">
                                <input onChange={onChangeEmail} value={email} className="signup_email" type="email" name="email" placeholder="이메일" />
                            </label>
                            <label className="password-label">
                                <input onChange={onChangePassword} value={password} className="signup_password" type="text" name="password" placeholder="비밀번호" />
                            </label>
                        ...
                        <div className="logined_span">
                                이미 가입하셨나요?
                            <button className="login_span">로그인</button>
                        </div>
